> Source: https://docs.dev.board.fun/unity/getting-started/sample — fetched 2026-06-04T18:38 (UTC-7)
...
Access active contacts via BoardInput.GetActiveContacts():
...
Process contact events using BoardContactPhase:
...
void ProcessContact(BoardContact contact)
{
    ...
    // Rotation in radians (for Pieces)
...
The sample demonstrates the debug overlay that visualizes Piece detection using BoardInput.enableDebugView:
