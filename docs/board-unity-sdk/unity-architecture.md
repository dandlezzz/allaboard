> Source: https://docs.dev.board.fun/unity/architecture — fetched 2026-06-04T18:38 (UTC-7)

# Unity SDK Architecture

Overview of the Board Unity SDK components. For the SDK-neutral platform pipeline (sensor, NPU, OS touch service), see Architecture.
...
Key APIs:
- BoardInput.GetActiveContacts() - Poll current contacts each frame in `Update()`
- BoardInput.settingsChanged - Input settings change notifications
...
- Contact Model — Shared contact shape and conventions
