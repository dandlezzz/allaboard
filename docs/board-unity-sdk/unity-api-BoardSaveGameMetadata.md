> Source: https://docs.dev.board.fun/unity/api/BoardSaveGameMetadata.html — fetched 2026-06-04T18:38 (UTC-7)

# BoardSaveGameMetadata Class (Board.Save)
...
Remarks: Read only properties are set by the native layer. Use BoardSaveGameMetadataChange to create/update the metadata for a save game.
